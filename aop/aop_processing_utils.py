...
def h5refl2array(h5_filename, raster, onlyMetadata = False, spatialIndexesToRead = None, bandIndexesToRead = None):
    ...
    if raster == 'Reflectance_Data':
        ...
        if 'bandNames' in rasterArray.attrs:
...
class YearSiteVisitClass:
    ...
    def __init__(self,YearSiteVisit,skipMissions = False):
        ...
        self.spectrometerAncillaryProductQaList = ['Weather_Quality_Indicator','Dark_Dense_Vegetation_Classification','Path_Length','Smooth_Surface_Elevation','Slope','Aspect','Water_Vapor_Column','Illumination_Factor','Sky_View_Factor']
    ...
    def getLidarProcessingParameters(self):
        ...
        self.lidarProcessingTileSize=500 #value in metres for size of tiles. If the following error warning appears during execution of any step "cannot alloc enough TIN triangles to triangulate X(a number) points", reduce the tilesize
        ...
        self.usgsBuffer = 2500 #units of meters
    ...
    def getMissions(self):
        ...
        for mission,payload in zip(self.MissionList,self.campaigns):
            ...
            mission = missionClass(mission,payload,self.site)
    ...
    def processMosaicQa(self):
        ...
        print('Getting report summariues for '+self.YearSiteVisit)
    ...
    def postLidarCleanup(self):
        ...
        ysv.zipLidarTileBoundaryFolder()
...
class missionClass:
    def __init__(self,missionId,payloadCampaign,site,dailyBaseDir=None,rawDir=None,doWaveform=True):
...
class LineClass:
    ...
    def processRadiance(self,rawSpectrometerDir,outputRadianceDir,outputQaDir,numCpus):
        ...
        if not os.path.exists(os.path.join(outputRadianceDir,self.radianceSpectrometerFile)):
            ...
            rawNisLine.gernerateRadianceWorkflow(outputRadianceDir)
            
            rawNisLine.generateRadianceQa(outputQaDir)
    ...
    def processOrthoRadiance(self,rawMissionSpectrometerDir,radianceDir,payload,leapSeconds,sbetFile,geoidFile,demFile,sapFile):
        ...
        if not os.path.exists(os.path.join(radianceDir,self.radianceOrtSpectrometerFile)):
            ...
            IDL.gps = float(payload.nisNominalTimingOffset)-1
